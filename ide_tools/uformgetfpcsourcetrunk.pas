...
type
  ...
  { TFormGetFPCSourceTrunk }

  TFormGetFPCSourceTrunk = class(TForm)
    Button1: TButton;
...
var
  FormGetFPCSourceTrunk: TFormGetFPCSourceTrunk;
...
procedure TFormGetFPCSourceTrunk.Button1Click(Sender: TObject);
var
  svnBinPath: string;
...
procedure TFormGetFPCSourceTrunk.SpeedButton1Click(Sender: TObject);
begin
    if SelectDirectoryDialog1.Execute then
     EditPathToSVN.Text:=SelectDirectoryDialog1.FileName;
end;

procedure TFormGetFPCSourceTrunk.SpeedButton2Click(Sender: TObject);
begin
    if SelectDirectoryDialog1.Execute then
       EditPathToFPCTrunk.Text:=SelectDirectoryDialog1.FileName;
end;

procedure TFormGetFPCSourceTrunk.SpeedButton6Click(Sender: TObject);
var
  auxStr: string;
begin
